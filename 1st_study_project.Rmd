...
server_2 <- function(input,output){
  output$plot_2 <- renderPlot({
    data = subset(df, rings>=input$rings[1] & rings<=input$rings[2] & sex %in% c('male','female','juvenil'))
